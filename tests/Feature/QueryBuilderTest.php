...
class QueryBuilderTest extends TestCase
{
    ...
    public function testWhereBetween()
    {
        ...
        $collection = DB::table("categories")
            ->whereBetween("created_at", ["2020-09-10 10:10:10", "2020-11-15 10:10:10"])
            ->get();
    ...
    public function testAggregate()
    {
        ...
        self::assertEquals(11500000.0000, $result);

        $result = DB::table("products")->sum("price");
        self::assertEquals(23000000, $result);
    }
    ...
    public function testQueryBuilderRaw()
    {
        ...
        self::assertEquals(3000000, $collection[0]->min_price);
